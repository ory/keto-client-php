...
# Contribute to Ory Ory Keto PHP Client<!-- omit in toc -->
...
1. Add a descriptive prefix to commits. This ensures a uniform commit history
   ...
   [Convential Commits configuration](https://github.com/ory/keto-client-php/blob/master/.github/workflows/conventional_commits.yml)
